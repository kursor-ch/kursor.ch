...
const RELATED_ARTICLES = [
  { href: "/meilleures-entreprises-suisses", icon: "\u{1F4CB}", tag: "ADMINISTRATIF", title: "Extrait du Registre du commerce : comment l’obtenir", author: "Laura B.", date: "10 avril 2026", readTime: "4 min" },
  { href: "/fiscalite-business", icon: "\u{1F4B3}", tag: "FINANCES", title: "TVA en Suisse : tout ce que les indépendants doivent savoir", author: "Karim D.", date: "2 avril 2026", readTime: "7 min" },
  { href: "/fiscalite-business", icon: "\u{1F3E2}", tag: "ENTREPRENDRE", title: "Domiciliation d’entreprise en Suisse : avantages et limites", author: "Julie M.", date: "18 mars 2026", readTime: "6 min" },
];
