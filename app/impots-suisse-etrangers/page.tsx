...
const RELATED_ARTICLES = [
  { href: "/fiscalite-business", icon: "\u{1F4CB}", tag: "FISCALIT\u00C9", title: "Optimisation fiscale en Suisse : 6 leviers pour 2026", author: "\u00C9quipe Kursor", date: "25 avril 2026", readTime: "16 min" },
  { href: "/retraite-suisse", icon: "\u{1F4B0}", tag: "PATRIMOINE", title: "3e pilier suisse : le guide complet 2026", author: "\u00C9quipe Kursor", date: "25 avril 2026", readTime: "12 min" },
  { href: "/impot-suisse", icon: "\u{1F4BC}", tag: "EMPLOI", title: "Calcul salaire net suisse frontalier", author: "\u00C9quipe Kursor", date: "22 avril 2026", readTime: "12 min" },
];
