...
const RELATED_ARTICLES = [
  { href: "/s-installer-en-suisse-pour-un-francais", icon: "\u{1F4BC}", tag: "EMPLOI", title: "Trouver un travail en Suisse : guide 2026", author: "Équipe Kursor", date: "Avril 2026", readTime: "15 min" },
  { href: "/impots-suisse-etrangers", icon: "\u{1F4B0}", tag: "EMPLOI", title: "Calcul salaire net suisse frontalier", author: "Équipe Kursor", date: "Avril 2026", readTime: "12 min" },
  { href: "/cout-vie-en-suisse", icon: "\u{1F465}", tag: "EMPLOI", title: "Coaching carrière en Suisse", author: "Équipe Kursor", date: "Avril 2026", readTime: "11 min" },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_280px] gap-10">
          ...
          <article>
            ...
            <p className="font-body" style={{ fontSize: 16, color: "#475569", lineHeight: 1.75, marginBottom: 24 }}>
              La Suisse abrite certaines des entreprises les plus reconnues au monde, dans des secteurs aussi variés que l{"’"}horlogerie, la pharma, la finance privée ou l{"’"}agroalimentaire — un écosystème porté aussi bien par les grands groupes que par <a href="/creation-entreprise" style={{ color: "#D97706", textDecoration: "underline" }}>la création d{"’"}entreprise en Suisse</a>, et qui attire chaque année des milliers de candidats internationaux, en particulier ceux qui souhaitent <a href="/s-installer-en-suisse-pour-un-francais" style={{ color: "#D97706", textDecoration: "underline" }}>s{"’"}installer en Suisse</a>. Voici la liste de référence des meilleures entreprises suisses en 2025-2026, classées par secteur, croisée avec le <strong style={{ color: "#111827" }}>Top 10 Randstad 2025</strong> et les classements Statista et Universum.
            </p>
