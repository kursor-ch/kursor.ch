...
import { PiggyBankIcon } from "@/components/ui/ServiceIcons";

export const metadata: Metadata = {
  title: "Audit Prévoyance — Kursor CH",
  description:
    "Calculez votre perte fiscale annuelle et découvrez combien vous pouvez rattraper avec la nouvelle loi 2026 sur le 3ème pilier. Bientôt disponible.",
};
    ...
    >
      <div className="max-w-xl w-full text-center">
        ...
        <p className="text-[15px] sm:text-base text-gray-500 font-body leading-relaxed max-w-md mx-auto mb-8">
          Calculez votre perte fiscale annuelle et découvrez combien vous
          pouvez rattraper avec la nouvelle loi 2026 sur le 3ème pilier. Cet
          audit arrive prochainement.
        </p>
