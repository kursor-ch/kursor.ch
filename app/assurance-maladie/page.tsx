    ...
    <div className="bg-creme">
      ...
      <section className="mx-auto px-6" style={{ maxWidth: 1120, paddingTop: 40, paddingBottom: 48 }}>
        <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_280px] gap-10">
          ...
          <article>
            {(() => {
              const img = getArticleImage("/assurance-maladie");
            ...
            <p className="font-body" style={{ fontSize: 15, color: "#475569", lineHeight: 1.75, marginBottom: 16 }}>
              La meilleure caisse maladie n{"\u2019"}existe pas dans l{"\u2019"}absolu : elle d{"\u00E9"}pend de votre profil, de votre canton de r{"\u00E9"}sidence et de vos habitudes de sant{"\u00E9"}, un arbitrage qui fait partie des {"\u00E9"}tapes cl{"\u00E9"}s pour <Link href="/s-installer-en-suisse-pour-un-francais" style={{ color: "#D97706", textDecoration: "underline", textUnderlineOffset: 3 }}>r{"\u00E9"}ussir son installation en Suisse</Link>. Posez-vous ces questions :
            </p>
