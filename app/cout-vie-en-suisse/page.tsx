        ...
        <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_280px] gap-10">
          ...
          <article>
            ...
            <p className="font-body" style={{ fontSize: 15, color: "#64748B", lineHeight: 1.7, marginBottom: 24, fontStyle: "italic" }}>
              Ce guide détaille les prix réels en 2026, poste par poste, en francs suisses, puis reconstruit des budgets mensuels concrets selon votre profil, à compléter par notre guide pour <a href="/s-installer-en-suisse-pour-un-francais" style={{ color: "#D97706", textDecoration: "underline" }}>s{"’"}installer en Suisse</a>. Données 2026, taux de change indicatif retenu : 1 CHF ≈ 1,07 €.
            </p>
