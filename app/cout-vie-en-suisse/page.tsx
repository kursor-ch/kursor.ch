...
const RELATED_ARTICLES = [
  ...
  { href: "/assurance-maladie", icon: "\u{1F3E5}", tag: "ASSURANCES", title: "Assurance maladie en Suisse : bien choisir", author: "Équipe Kursor", date: "Avril 2026", readTime: "15 min" },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_280px] gap-10">
          ...
          <article>
            ...
            <p className="font-body" style={{ fontSize: 15, color: "#64748B", lineHeight: 1.7, marginBottom: 24, fontStyle: "italic" }}>
              Ce guide détaille les prix réels en 2026, poste par poste, en francs suisses, puis reconstruit des budgets mensuels concrets selon votre profil, à compléter par notre guide pour <a href="/s-installer-en-suisse-pour-un-francais" style={{ color: "#D97706", textDecoration: "underline" }}>s{"’"}installer en Suisse</a>, ou notre dossier dédié pour <a href="/prendre-sa-retraite-en-suisse" style={{ color: "#D97706", textDecoration: "underline" }}>prendre sa retraite en Suisse</a> si vous arrivez à la retraite. Données 2026, taux de change indicatif retenu : 1 CHF ≈ 1,07 €.
            </p>
