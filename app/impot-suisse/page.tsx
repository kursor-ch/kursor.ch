...
const RELATED_ARTICLES = [
  ...
  { href: "/fiscalite-business", icon: "\u{1F4C8}", tag: "FISCALITÉ", title: "Optimisation fiscale en Suisse : 6 leviers pour 2026", author: "Équipe Kursor", date: "25 avril 2026", readTime: "16 min" },
  { href: "/retraite-suisse", icon: "\u{1F3AF}", tag: "PATRIMOINE", title: "3e pilier suisse : le guide complet 2026", author: "Équipe Kursor", date: "25 avril 2026", readTime: "12 min" },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_280px] gap-10">
          ...
          <article>
            ...
            <div className="rounded-xl" style={{ backgroundColor: "#FFFBF0", border: "1px solid rgba(217,119,6,0.25)", padding: "20px 24px", marginBottom: 32 }}>
              ...
              <p className="font-body" style={{ fontSize: 14, color: "#475569", lineHeight: 1.65 }}>
                Les barèmes d{"’"}impôt en Suisse forment un système à trois étages : <strong style={{ color: "#111827" }}>IFD fédéral progressif</strong> (0 % à 11,5 %), <strong style={{ color: "#111827" }}>barème cantonal</strong> (26 systèmes différents, du flat tax uranais aux 17 tranches genevoises), et <strong style={{ color: "#111827" }}>coefficient communal</strong> (multiplicateur de 50 % à 120 %+). Pour calculer son impôt : revenu imposable après déductions, IFD, barème cantonal avec splitting éventuel, centimes additionnels, coefficient communal. Trois leviers d{"’"}optimisation : choix de la commune, déterminant pour <a href="/s-installer-en-suisse-pour-un-francais" style={{ color: "#D97706", textDecoration: "underline" }}>s{"’"}installer en Suisse</a>, déductions (3e pilier, rachats LPP), splitting automatique pour les couples mariés. Pour aller plus loin, consultez notre guide complet sur <a href="/fiscalite-business" style={{ color: "#D97706", textDecoration: "underline" }}>l{"’"}optimisation fiscale en Suisse</a>.
              </p>
            </div>
