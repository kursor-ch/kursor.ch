        ...
        <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_280px] gap-10">
          ...
          <article>
            ...
            <div className="rounded-xl" style={{ backgroundColor: "#FFFBF0", border: "1px solid rgba(217,119,6,0.25)", padding: "20px 24px", marginBottom: 32 }}>
              ...
              <p className="font-body" style={{ fontSize: 14, color: "#475569", lineHeight: 1.65 }}>
                Les barèmes d{"’"}impôt en Suisse forment un système à trois étages : <strong style={{ color: "#111827" }}>IFD fédéral progressif</strong> (0 % à 11,5 %), <strong style={{ color: "#111827" }}>barème cantonal</strong> (26 systèmes différents, du flat tax uranais aux 17 tranches genevoises), et <strong style={{ color: "#111827" }}>coefficient communal</strong> (multiplicateur de 50 % à 120 %+). Pour calculer son impôt : revenu imposable après déductions, IFD, barème cantonal avec splitting éventuel, centimes additionnels, coefficient communal. Trois leviers d{"’"}optimisation : choix de la commune — déterminant lors d{"’"}une <a href="/s-installer-en-suisse-pour-un-francais" style={{ color: "#D97706", textDecoration: "underline" }}>installation en Suisse pour un Français</a> —, déductions (3e pilier, rachats LPP), splitting automatique pour les couples mariés. Pour aller plus loin, consultez notre guide complet sur <a href="/fiscalite-business" style={{ color: "#D97706", textDecoration: "underline" }}>l{"’"}optimisation fiscale en Suisse</a>.
              </p>
            </div>
