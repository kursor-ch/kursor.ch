...
const RELATED_ARTICLES = [
  { href: "/s-installer-en-suisse-pour-un-francais", icon: "\u{1F1EB}\u{1F1F7}", tag: "S'INSTALLER", title: "S'installer en Suisse pour un Français", author: "Équipe Kursor", date: "Juin 2026", readTime: "14 min" },
  ...
  { href: "/impots-suisse-etrangers", icon: "\u{1F4DD}", tag: "FISCALITÉ", title: "Impôts en Suisse pour les étrangers", author: "Équipe Kursor", date: "Avril 2026", readTime: "18 min" },
];
