        ...
        <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_280px] gap-10">
          ...
          <article>
            ...
            <p className="font-body" style={{ fontSize: 15, color: "#475569", lineHeight: 1.75, marginBottom: 16 }}>
              L’imposition suisse repose sur <strong style={{ color: "#111827" }}>trois niveaux superposés</strong> : la Confédération, le canton et la commune. L’impôt fédéral direct est uniforme sur tout le territoire, mais les impôts cantonaux et communaux varient massivement. Un même revenu peut être taxé près de deux fois plus à Genève qu’à Zoug, comme le montre notre comparatif sur <a href="/impot-suisse" style={{ color: "#D97706", textDecoration: "underline" }}>les taux d’imposition en Suisse</a>.
            </p>
            ...
            <p className="font-body" style={{ fontSize: 15, color: "#475569", lineHeight: 1.75, marginBottom: 16 }}>
              Le <strong style={{ color: "#111827" }}>3e pilier A</strong> reste le geste le plus rentable accessible à tous. Chaque franc versé est déduit du revenu imposable au niveau fédéral et cantonal. Pour un contribuable au taux marginal de 35 %, un versement de 7 258 CHF représente une économie immédiate d’environ <strong style={{ color: "#111827" }}>2 540 CHF</strong>. Pour comprendre en profondeur <a href="/retraite-suisse" style={{ color: "#D97706", textDecoration: "underline" }}>le 3e pilier suisse</a>, consultez notre guide dédié.
            </p>
            <p className="font-body" style={{ fontSize: 15, color: "#475569", lineHeight: 1.75, marginBottom: 16 }}>
            ...
            <p className="font-body" style={{ fontSize: 15, color: "#475569", lineHeight: 1.75, marginBottom: 16 }}>
              Au moment de toucher la prévoyance, deux décisions changent tout. La première : <strong style={{ color: "#111827" }}>capital ou rente ?</strong> Le capital est imposé une seule fois, à un taux séparé et réduit ; la rente est intégrée chaque année au revenu imposable. Sur 20 ans de retraite, l’écart fiscal cumulé peut dépasser <strong style={{ color: "#111827" }}>100 000 CHF</strong> pour un avoir conséquent. Pour bien préparer cette étape, notre analyse sur <a href="/analyse-lpp" style={{ color: "#D97706", textDecoration: "underline" }}>le placement suisse</a> détaille les options.
            </p>
            <p className="font-body" style={{ fontSize: 15, color: "#475569", lineHeight: 1.75, marginBottom: 32 }}>
