...
export default function ConsentScreen({ onSubmit, onBack }: ConsentScreenProps) {
  ...
  useEffect(() => {
    pushEvent("assurance_consent_shown");
  }, []);
    ...
    <div className="animate-screen-in space-y-8">
      ...
      <div className="space-y-4">
        ...
        >
          ...
          <div>
            <span className="text-sm font-medium text-gray-800 leading-relaxed font-body">
              Je souhaite être mis en relation avec notre spécialiste assurance
              santé indépendant. Gratuit et sans engagement.
            </span>
            <input
              type="checkbox"
      ...
      <div className="flex gap-3 pt-2">
        ...
        >
          {isSubmitting ? "Envoi en cours…" : "Voir mon audit assurance →"}
        </button>
      </div>
    </div>
  );
